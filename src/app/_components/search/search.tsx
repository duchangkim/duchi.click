    ...
    <GlobalPortal.Consumer>
      ...
      >
        ...
        <div className="pointer-events-none fixed left-0 top-0 z-auto flex h-full w-full justify-center">
          <div
            role="dialog"
            className="pointer-events-auto mb-[100px] mt-[100px] flex h-fit max-h-[80%] min-w-[80%] max-w-[80%] flex-col overflow-y-auto rounded-md border border-zinc-600 bg-white shadow-md dark:border-zinc-700 dark:bg-neutral-900 lg:min-w-[1024px] lg:max-w-[1024px]"
          >
